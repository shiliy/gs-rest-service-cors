...
include::https://github.com/spring-guides/getting-started-macros/master/how_to_complete_this_guide.adoc[]

include::https://github.com/spring-guides/getting-started-macros/master/hide-show-gradle.adoc[]

include::hhttps://github.com/spring-guides/getting-started-macros/master/hide-show-maven.adoc[]

include::https://github.com/spring-guides/getting-started-macros/master/hide-show-sts.adoc[]
