...
:java_version: 1.8
include::https://github.com/spring-guides/getting-started-macros/blob/master/prereq_editor_android_buildtools.adoc[]

include::https://github.com/spring-guides/getting-started-macros/blob/master/how_to_complete_this_guide.adoc[]

include::https://github.com/spring-guides/getting-started-macros/blob/master/hide-show-gradle.adoc[]

include::https://github.com/spring-guides/getting-started-macros/blob/master/hide-show-maven.adoc[]

include::https://github.com/spring-guides/getting-started-macros/blob/master/hide-show-sts.adoc[]
